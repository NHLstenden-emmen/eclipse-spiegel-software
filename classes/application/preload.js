...
ipcRenderer.on('websocket', function (evt, message) {
  //  console.log(message.message); // Returns: {'SAVED': 'File Saved'}
  let json = JSON.parse(message.message);
  console.log(json)
  update_locations(json);
});

document.addEventListener('DOMContentLoaded', () => {
    test = '{"0":["catfact"],"1":["empty"],"2":["empty"],"3":["empty"],"4":["empty"],"5":["empty"],"6":["empty"],"7":["empty"],"8":["empty"],"9":["empty"],"10":["empty"],"11":["empty"],"12":["empty"],"13":["empty"],"14":["empty"],"15":["empty"],"16":["empty"],"17":["empty"],"18":["empty"],"19":["empty"],"20":["empty"],"21":["empty"],"22":["morning"],"23":["empty"],"24":["empty"],"25":["empty"],"26":["empty"],"27":["empty"],"28":["empty"],"29":["empty"],"30":["empty"],"31":["empty"],"32":["empty"],"33":["empty"],"34":["empty"],"35":["empty"],"36":["empty"],"37":["empty"],"38":["empty"],"39":["empty"],"40":["empty"],"41":["empty"],"42":["empty"],"43":["empty"],"44":["empty"]}';
...
function update_locations(responseWidgetLocation) {
    hide();
   // responseWidgetLocation = JSON.parse(LocationJSONArray);
...
function retrieve_widget_data() {
    ...
    console.log("retrieve widget data");
...
function show() {
    ...
    var timershow = setInterval(function () {
        if (Opacity >= 1) {
            ...
            //console.log("shows" + Opacity);
            gridlayout.style.opacity = Opacity;
...
function display_catfact() {
    for (catfactIndex = 0; catfactIndex < widgetResponse.length; catfactIndex++) {
        if (widgetResponse[catfactIndex].type == "catfact") {
            catfact = widgetResponse[catfactIndex].recentdata;
            try {
                document.getElementById('catfacttxt').innerHTML = catfact;
            } catch (error) {
                return;
            }
        }
        ...
        for (newsIndex = 0; newsIndex < widgetResponse.length; newsIndex++) {
            if (widgetResponse[newsIndex].type == news) {
                ...
                for (newsIndex2 = 0; newsIndex2 < newsdataArray[newsElementsIndex].length; newsIndex2++) {
                    newsdataArray[newsElementsIndex][newsIndex2] = newsdataArray[newsElementsIndex][newsIndex2].slice(21, newsdataArray[newsElementsIndex][newsIndex2].length)
                }
...
function timer_news() {
    ...
    var news_timer = setInterval(() => {loop_news()}
    , 10000);
}
...
function timer_time() {
    ...
    var time_timer = setInterval(() => {display_time()}
    , 1000);
}
